...
const ContactSection = () => {
  return (
    <section id="contact" className="py-20 px-4 bg-gradient-to-br from-indigo-900 via-blue-900 to-slate-900">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Contactez-moi</h2>
          <div className="h-1 w-20 bg-white/50 mx-auto rounded-full mb-6" />
          <p className="text-xl text-gray-200 mb-2">Disponible pour un CDI à partir de</p>
          <p className="text-3xl font-bold text-indigo-300">Janvier 2026</p>
        </div>

        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <a 
            href="mailto:msalamatanourou@gmail.com" 
            className="flex flex-col items-center gap-3 p-6 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all border border-white/20"
          >
            <Mail size={32} className="text-indigo-300" />
            <div className="text-sm text-gray-200">
              <div className="font-semibold mb-1">Email</div>
              msalamatanourou@gmail.com
            </div>
          </a>

          <a 
            href="tel:+33753472490" 
            className="flex flex-col items-center gap-3 p-6 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all border border-white/20"
          >
        ...
        <div className="flex justify-center gap-6">
          <a 
            href="https://github.com/Salambaye" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="p-4 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all border border-white/20 hover:scale-110"
            aria-label="GitHub"
          >
            <Github size={28} className="text-white" />
          </a>
          <a 
            href="https://www.linkedin.com/in/salamata-nourou-mbaye" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="p-4 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all border border-white/20 hover:scale-110"
            aria-label="LinkedIn"
          ...
          <a 
            href="https://mon-portfolio-2sfc.vercel.app" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="p-4 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all border border-white/20 hover:scale-110"
