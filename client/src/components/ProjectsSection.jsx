    ...
    <section id="projects" className="py-20 px-4 bg-slate-900">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Projets Académiques</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div 
              key={index}
              className="group bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-2xl border border-indigo-500/20 hover:border-indigo-500/40 transition-all hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2"
            >
              <div className="mb-4">
                <span className="text-sm text-gray-400 font-mono">{project.period}</span>
                <h3 className="text-2xl font-bold text-white mb-3 mt-2 flex items-center justify-between">
                  {project.title}
                  {project.link && (
                    <a 
                      href={project.link} 
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((tech) => (
                  <span 
                    key={tech} 
                    className="px-3 py-1 bg-slate-700/50 text-gray-300 rounded-full text-xs border border-slate-600"
                  >
                    {tech}
                  </span>
                ))}
